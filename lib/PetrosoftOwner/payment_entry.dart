...
import 'package:petrosoft_india/PetrosoftOwner/add_payment_entry.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
       // backgroundColor: Colors.indigo.shade100,
        appBar: AppBar(title:  Text('Payment Entry',style: PetroSoftTextStyle.style17White,), titleSpacing:0.0,backgroundColor: ColorsForApp.appThemeColor),
        body: Center(
          child: Padding(
