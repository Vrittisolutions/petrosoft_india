...
class ManagerAddCreditSale extends StatefulWidget {
  final String mode;
  final Map selectedRow;
  const ManagerAddCreditSale({Key? key, required this.mode,required this.selectedRow}) : super(key: key);

  @override
  _ManagerAddCreditSaleState createState() => _ManagerAddCreditSaleState();
}

class _ManagerAddCreditSaleState extends State<ManagerAddCreditSale> {
  dynamic resPdf;
  ...
  Future<bool?> _willPopCallback()async{
    return Navigator.of(context)
      ...
      return  const ManagerCreditSale();
    }));
   ...
   /* if(UT.m["Selected_item_rate"]!=''){
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title:  Text('Add Credit Sale',style: PetroSoftTextStyle.style17White,),
            actions: [
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child:IconButton(
                          ...
                          icon: Icon(Icons.camera_alt,color: ColorsForApp.appThemeColor,),
    ...
    return  Padding(
        ...
        child:InkWell(
          ...
          child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(12.0),
                child: Text(_pumpName!=null&&_pumpName!=''?_pumpName:"Select Pump No",
                    style:_pumpName!=null&&_pumpName!=''? StyleForApp.text_style_bold_13_black : StyleForApp.text_style_normal_13_black),
              )
          ),
        ));
  }
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(context,
                                MaterialPageRoute(
                                    builder: (context) => ManagerCreditSale()));
                            // Navigator.pop(context);
                          }
                      ),
                      ElevatedButton(
                  ...
                  ButtonBar(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                          ...
                          child: const Text("Cancel"),
                          onPressed: () {
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManagerCreditSale()));
                            // Navigator.pop(context);
                          }
                      ),
                      ElevatedButton(
