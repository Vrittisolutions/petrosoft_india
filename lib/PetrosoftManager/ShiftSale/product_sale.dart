...
class ManagerProductSale extends StatefulWidget {
  const ManagerProductSale({Key? key}) : super(key: key);

  @override
  _ManagerProductSaleState createState() => _ManagerProductSaleState();
}

class _ManagerProductSaleState extends State<ManagerProductSale> {
