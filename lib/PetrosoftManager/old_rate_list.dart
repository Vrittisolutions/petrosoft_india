...
class MangerOldRateList extends StatefulWidget {
  final String validFromDate,validUptoDate;
  const MangerOldRateList({Key? key, required this.validFromDate,required this.validUptoDate}) : super(key: key);
  @override
  _MangerOldRateListState createState() => _MangerOldRateListState();
}

class _MangerOldRateListState extends State<MangerOldRateList> {
  ...
  Future<bool?> _willPopCallback() async {
    return Navigator.of(context)
      ...
      return const ManagerRateMaster();
    }));
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    child: Row(
                      children: [
                        Text("From Date : "+UT.dateMonthYearFormat(widget.validFromDate),style: StyleForApp.text_style_bold_14_black,),
                        SizedBox(width: 10,),
                        Text("To Date : "+UT.dateMonthYearFormat(widget.validUptoDate),style: StyleForApp.text_style_bold_14_black)
                      ],
                    ),
                  ),
                ),
