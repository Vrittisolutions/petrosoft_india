...
class ManagerPendingOrders extends StatefulWidget {
  const ManagerPendingOrders({Key? key}) : super(key: key);
  @override
  _ManagerPendingOrdersState createState() => _ManagerPendingOrdersState();
}

class _ManagerPendingOrdersState extends State<ManagerPendingOrders> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     // backgroundColor: Colors.indigo.shade100,
      ...
      appBar: AppBar(title: const Text('Pending Orders',), backgroundColor: ColorsForApp.app_theme_color_owner),
      body: Center(
        child: FutureBuilder(
          future: getData(),
  ...
  saveData(String credVou) async {
    ...
    if(Result1=="ok"){
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManagerPendingOrders()));
    }
  }
}
