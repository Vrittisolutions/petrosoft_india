               ...
               child: SizedBox(
                 ...
                 child: DataTable(
                   ...
                   columns:  <DataColumn>[
                     ...
                     DataColumn(label: Text("Balance",style: PetroSoftTextStyle.style15BlackBold,)),
                           ...
                           cells: <DataCell>[
                             ...
                             DataCell(
                                 Align(
                                   ...
                                   child: Text( customerLedgerData[index]["balance"].toStringAsFixed(2).toString(),
                               style: PetroSoftTextStyle.style13Black,),
                                 ),
                                 onTap: () {
                                   Navigator.push(
                                       context,
