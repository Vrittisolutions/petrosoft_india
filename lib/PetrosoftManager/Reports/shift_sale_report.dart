...
class ShiftSaleReport extends StatefulWidget {
  const ShiftSaleReport({Key? key}) : super(key: key);

  @override
  _ShiftSaleReportState createState() => _ShiftSaleReportState();
}

class _ShiftSaleReportState extends State<ShiftSaleReport> {
